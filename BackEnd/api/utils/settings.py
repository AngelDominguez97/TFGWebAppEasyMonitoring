...
class EnvVariables(BaseSettings):
    ...
    ro_comm:str = os.getenv('RO_COMM')
    # SNMP v 3
    user_snmp_v3:str = os.getenv('USER_SNMP_V3')
    auth_snmp_v3:str = os.getenv('AUTH_SNMP_V3')
    priv_snmp_v3:str = os.getenv('PRIV_SNMP_V3')
...
class Oids(BaseSettings):
    ...
    # In bits to MB
    NET_TRAFFIC_IN_1M = ".1.3.6.1.2.1.31.1.1.1.6.1"
    NET_TRAFFIC_IN_5M = ".1.3.6.1.2.1.31.1.1.1.6.2"
    NET_TRAFFIC_IN_15M = ".1.3.6.1.2.1.31.1.1.1.6.3"
    NET_TRAFFIC_OUT_1M = ".1.3.6.1.2.1.31.1.1.1.10.1"
    NET_TRAFFIC_OUT_5M = ".1.3.6.1.2.1.31.1.1.1.10.2"
    NET_TRAFFIC_OUT_15M = ".1.3.6.1.2.1.31.1.1.1.10.3"
    # In bytes to GB
